...
struct BuildURLMovil {
    ...
    static let actionVerCita = ""
    static let actionVerInforme = ""
    static let actionVerParteMedico = ""
    static let actionVerMisDatos = ""
    static let actionVerProtocoloYSeguridad = ""
    static let actionPedirAltaVoluntaria = ""
    static let actionSubirDocumento = ""
    static let actionComunicarParte = ""
    ...
    static func verCita() -> String { getURLUsada() + actionVerCita }
    static func verInforme() -> String { getURLUsada() + actionVerInforme }
    static func verParteMedico() -> String { getURLUsada() + actionVerParteMedico }
    static func verMisDatos() -> String { getURLUsada() + actionVerMisDatos }
    static func verProtocoloYSeguridad() -> String { getURLUsada() + actionVerProtocoloYSeguridad }
    static func pedirAltaVoluntaria() -> String { getURLUsada() + actionPedirAltaVoluntaria }
    static func subirDocumento() -> String { getURLUsada() + actionSubirDocumento }
    static func comunicarParte() -> String { getURLUsada() + actionComunicarParte }
